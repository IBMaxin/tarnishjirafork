...
class IdleLogoutPacketListenerTest {

    private Player player;
    private IdleLogoutPacketListener listener;

    @BeforeEach
    void setUp() {
        player = new Player("TestPlayer");
        listener = new IdleLogoutPacketListener();
    }

    @Test
    void handlePacket_validPayload_setsIdleFlag() {
        GamePacket packet = createPacket(202);
    ...
    @Test
    void handlePacket_emptyPayload_doesNotCrashAndSetsIdleFlag() {
        GamePacket packet = createPacket(202);
