...
public enum FightType {
   ...
   /* GHRAZI_STAB(390, 4, 1, 43, 0, 2282, Equipment.STAB_OFFENSE, FightStyle.ACCURATE),
    ...
    SHADOW_ACCURATE(9493, 10, 8, 43, 0, 791, Equipment.MAGIC_OFFENSE, FightStyle.ACCURATE),
    SHADOW_RAPID(9493, 9, 8, 43, 1, 791, Equipment.MAGIC_OFFENSE, FightStyle.AGGRESSIVE),
    SHADOW_LONGRANGE(9493, 10, 8, 43, 2, 791, Equipment.MAGIC_OFFENSE, FightStyle.DEFENSIVE),
