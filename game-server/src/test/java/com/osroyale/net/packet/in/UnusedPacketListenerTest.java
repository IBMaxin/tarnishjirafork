...
class UnusedPacketListenerTest {

    @Test
    void handlePacket_anyUnusedOpcode_doesNotThrow() {
        Player player = new Player("TestPlayer");
        UnusedPacketListener listener = new UnusedPacketListener();
        GamePacket packet = createPacket(3);
